...
function serverGetJson(){
  let url = "http://30044.hosts2.ma-cloud.nl/bewijzenmap/periode1.3/pib/pib2020/drawing.json"
  makeAjaxCall(url, "GET"). then (readJson, errorHandler);
}

function preload(){
  let url = "http://30044.hosts2.ma-cloud.nl/bewijzenmap/periode1.3/pib/pib2020/preload.json"
